            ...
            <div className="flex h-full">
                <div className="w-2/5 h-full">
                    <div className="flex h-full">
                        ...
                        <div className="w-5/6 text-white text-center flex flex-col" id="photoDiv">
                            ...
                            <span className="italic">Only a life lived for others is a life worthwhile.</span>
                        </div>
                    </div>
                </div>
                <div className="w-3/5 my-20 bg-mainGray">
