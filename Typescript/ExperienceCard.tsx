        ...
        if (this.props.Description != undefined || this.props.Technologies.length != 0) {
            iconsColumn = (
                <div className="w-6 flex flex-col">
                    {this.props.Description != undefined ? <a onClick={this.showModal} className="ml-auto inline-block cursor-pointer experienceCard">{descIcon}</a> : ""}
                    {this.props.Technologies.length != 0 ? <a className="ml-auto inline-block mt-auto cursor-pointer experienceCard">{techIcon}</a> : ""}
                </div>
            )
        }
